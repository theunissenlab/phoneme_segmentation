...
class SemanticModel(object):
    ...
    def find_words_like_word(self, word, n=10):
        ...
        """
        #print (self.vocab[100:110])        
        #print (type(self.vocab[0]))
        self.vocab_new = [v.decode("utf-8") for v in self.vocab]
        return self.find_words_like_vec(self.data[:,self.vocab_new.index(word)], n)
